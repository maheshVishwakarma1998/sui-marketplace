...
///
module shoe_store::royalty_rule {
    use sui::sui::SUI;
    ...
    public fun add(
        policy: &mut TransferPolicy<Shoe>,
        cap: &TransferPolicyCap<Shoe>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<Shoe>,
        request: &mut TransferRequest<Shoe>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<Shoe>, paid: u64): u64 {
